...
echo "<tr><td width='300'>Nama</td><td width='600'><input type='hidden' name='id' value='$id'><input size='50' type='text' name='nama' value='$nama'></td></tr>";
echo "<tr><td>Daerah Asal</td><td><input size='50' type='text' name='asal' value='$asal'></td></tr>";
echo "<tr><td>Usia</td><td><input type='text' name='usia' value='$usia'></td></tr>";
...
echo "<tr><td>Alasan Berwisata</td><td><input size='50' type='text' name='alasan' value='$alasan'></td></tr>";
...
echo "<tr><td>Jatim Park 1</td><td><input type='text' name='penilaianjatimpark1' value='$penilaianjatimpark1'></td></tr>";
echo "<tr><td>Jatim Park 2</td><td><input type='text' name='penilaianjatimpark2' value='$penilaianjatimpark2'></td></tr>";
echo "<tr><td>Jatim Park 3</td><td><input type='text' name='penilaianjatimpark3' value='$penilaianjatimpark3'></td></tr>";
echo "<tr><td>Museum Angkut</td><td><input type='text' name='penilaianmuseumangkut' value='$penilaianmuseumangkut'></td></tr>";
echo "<tr><td>Selecta</td><td><input type='text' name='penilaianselecta' value='$penilaianselecta'></td></tr>";
echo "<tr><td>BNS</td><td><input type='text' name='penilaianbns' value='$penilaianbns'></td></tr>";
echo "<tr><td>Eco Green Park</td><td><input type='text' name='penilaianecogreenpark' value='$penilaianecogreenpark'></td></tr>";
echo "<tr><td>Alun-alun Kota Batu</td><td><input type='text' name='penilaianalunalunkotabatu' value='$penilaianalunalunkotabatu'></td></tr>";
echo "<tr><td>Kusuma Agro</td><td><input type='text' name='penilaiankusumaagro' value='$penilaiankusumaagro'></td></tr>";
echo "<tr><td>Cangar</td><td><input type='text' name='penilaiancangar' value='$penilaiancangar'></td></tr>";
echo "<tr><td>Coban Talun</td><td><input type='text' name='penilaiancobantalun' value='$penilaiancobantalun'></td></tr>";
echo "<tr><td>Pemandian Songgoriti</td><td><input type='text' name='penilaianpemandiansonggoriti' value='$penilaianpemandiansonggoriti'></td></tr>";
echo "<tr><td>Coban Rais</td><td><input type='text' name='penilaiancobanrais' value='$penilaiancobanrais'></td></tr>";
echo "<tr><td>Predator Fun Park</td><td><input type='text' name='penilaianpredatorfunpark' value='$penilaianpredatorfunpark'></td></tr>";
?>
